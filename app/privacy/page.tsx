  ...
  return (
    <main>
      ...
      <article className="legal shell">
        ...
        <p className="legal-date">Last updated: September 12, 2026</p>
        ...
        <p>We may disclose information to hosting, database, email, payment, analytics, security, support, professional-adviser and operational service providers where reasonably necessary to deliver or protect the service. We may also disclose information when required by law, valid legal process, or to protect rights, safety, property, and service integrity. We do not sell personal information for money. If you allow optional measurement, we may share website and conversion event information with Meta and Google for analytics and advertising measurement; Meta conversion matching can include hashed contact details after an accepted enquiry.</p>
        ...
        <p>We use browser storage to remember your privacy choice and a private bKash order reference within your tab. Optional Meta Pixel, Meta Conversions API and Google tag measurement run only after you allow measurement. This can include page visits and accepted enquiries, Meta browser identifiers, Google measurement identifiers generated by Google&apos;s tag, and hashed email or phone details sent to Meta for conversion matching. Hashing does not make contact information anonymous. Use Privacy choices to withdraw permission for future Meta and Google measurement. Vercel Analytics and Speed Insights measure site usage and performance separately. We store bKash sender numbers, transaction IDs, dates and amounts for owner verification; we never request your bKash PIN or OTP.</p>
