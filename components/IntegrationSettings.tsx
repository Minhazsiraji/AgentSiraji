...
export function IntegrationSettings() {
  ...
  return <div style={{ display: "grid", gap: 22 }}>
    ...
    <section className="glass-card" style={{ padding: 24 }}><h2>Google tag</h2><p>Store the AgentSiraji GA4 Measurement ID, Google Ads ID, or Google tag ID. Supported prefixes are G-, AW- and GT-. The optional API secret stays server-side.</p><div className="form-row">{input("googleMeasurementId", "Google tag / measurement ID", false, "G-XXXXXXXXXX, AW-XXXXXXXXX or GT-XXXXXXX")}{input("googleApiSecret", "Google API secret (optional)", true, "Server-side secret")}</div></section>
